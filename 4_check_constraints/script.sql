CREATE TABLE Product (
	Cement_ID INT AUTO_INCREMENT PRIMARY KEY,
	Cement_Name VARCHAR(100) NOT NULL,
...
CREATE TABLE Stock_Control (
	...
	FOREIGN KEY (Cement_ID) REFERENCES Product(Medicine_ID) ON DELETE CASCADE
) ENGINE=InnoDB;
 
 
CREATE INDEX idx_CementName ON Product (Medicine_Name);
...
-- Grant privileges to other team members
GRANT ALL PRIVILEGES ON <167004>_project.* TO <151311>@%;
GRANT ALL PRIVILEGES ON <167004>_project.* TO <170278>@%;
GRANT ALL PRIVILEGES ON <167004>_project.* TO <169977>@%;
GRANT ALL PRIVILEGES ON <167004>_project.* TO <160849>@%;
